...
$_SESSION['msg']="Hardware Returned successfully";
...
<head>
    ...
    <title>Online Hardware Management System | Issued Hardware Details</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Issued Hardware Details</h4>
...
<div class="col-md-6"> 
<div class="form-group">
<label>Hardware Issued Date :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Hardware Returned Date :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Return Hardware </button>
