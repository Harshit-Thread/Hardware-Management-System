...
if($lastInsertId)
{
$_SESSION['msg']="Hardware issued successfully";
...
<head>
    ...
    <title>Online Hardware Management System | Issue a new Hardware</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Issue a New Hardware</h4>
...
<div class="form-group">
<label>Sr No or Title<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Issue Hardware </button>
