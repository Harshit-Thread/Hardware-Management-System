...
if($lastInsertId)
{
echo "<script>alert('Hardware Listed successfully');</script>";
...
<head>
    ...
    <title>Online Hardware Management System | Add Hardware</title>
...
<p class="help-block">A Sr No Must be unique</p>
