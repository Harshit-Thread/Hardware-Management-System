...
<head>
    ...
    <title>Online Hardware Management System | Edit Hardware</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add Hardware</h4>
...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Change Hardware Image</a>
</div></div>

<div class="col-md-6">
<div class="form-group">
<label>Hardware Name<span style="color:red;">*</span></label>
...
<p class="help-block">.SrNo Must be unique</p>
</div></div>
